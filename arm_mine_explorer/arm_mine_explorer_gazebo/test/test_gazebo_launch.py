...
def generate_test_description():
    ...
    pkg_gazebo = get_package_share_directory('arm_mine_explorer_gazebo')
...
class TestGazeboIntegration(unittest.TestCase):
    ...
    def test_arm_controller_is_available(self):
        """Check if the arm_controller has been successfully loaded."""
        ...
        self.assertTrue(controller_found, 'Arm controller topic not found!')
