...
def generate_test_description():
    ...
    launch_file_path = os.path.join(pkg_gazebo, 'launch', 'lidar_hdl32e_display.launch.py')
...
class TestGazeboIntegration(unittest.TestCase):
    ...
    def test_lidar_topic_is_available(self):
        """Check if the lidar topic is available."""
        ...
        self.assertTrue(topic_found, 'Topic not found!')
